...
function Page11() {
  return (
    <div className="h-[150vh] 2xl:h-[110vh] xl:h-[150vh] lg:h-[180vh] md:h-[140vh] sm:h-[210vh] min-[375px]:h-[205vh] min-[320px]:h-[210vh] p-3 lg:p-3 min-[320px]:p-2 bg-white">
      <div className="h-full p-16 xl:p-16 lg:p-10 md:p-10 min-[320px]:py-8 min-[320px]:px-4 flex md:flex min-[320px]:block  justify-between w-full shadow-neutral-900 shadow-md bg-black rounded-[35px] overflow-hidden relative">
       ...
       <div className="right w-3/5 text-lg lg:w-3/5 min-[320px]:w-full md:static min-[320px]:absolute min-[320px]:bottom-36 min-[425px]:bottom-20">
        ...
        <div className="my-12 lg:my-12 min-[320px]:my-8">
            ...
            <p className="font-[anzo2] leading-6 mt-1 lg:text-base min-[320px]:text-xs lg:leading-6 min-[320px]:leading-4 min-[320px]:pr-6 md:pr-0">Every project begins with a deep dive into its essence—balancing meticulous planning, agile adaptability, and uncompromising transparency.</p>
        </div>
        <div>
            ...
            <p className="font-[anzo2] leading-6 mt-1 lg:text-base min-[320px]:text-xs lg:leading-6 min-[320px]:leading-4 min-[320px]:pr-5 md:pr-0">I design not just for beauty but for harmony—interfaces that marry form with function, captivating users while delivering seamless usability</p>
        </div>
        <div className="my-12 lg:my-12 min-[320px]:my-8">
        ...
        <div>
            ...
            <p className="font-[anzo2] leading-6 mt-1 lg:text-base min-[320px]:text-xs lg:leading-6 min-[320px]:leading-4 min-[320px]:pr-7 md:pr-0">The ideal solution isn’t just one-size-fits-all—it’s a bespoke creation that aligns with your unique needs, aspirations, and vision.</p>
        </div>
        <div className="my-12 lg:my-12 min-[320px]:my-8">
            ...
            <p className="font-[anzo2] leading-6 mt-1 lg:text-base min-[320px]:text-xs lg:leading-6 min-[320px]:leading-4 min-[320px]:pr-6 md:pr-0">Time, creativity, and expertise are my most valuable resources, and I invest them wholeheartedly in every project.</p>
        </div>
        <div>
            ...
            <p className="font-[anzo2] leading-6 mt-1 lg:text-base min-[320px]:text-xs lg:leading-6 min-[320px]:leading-4 min-[320px]:pr-9 md:pr-0">Your online presence is more than a platform—it’s your story, your signature. Together, we’ll craft a first impression that lingers</p>
        </div>
        </div>
      </div>
    </div>
