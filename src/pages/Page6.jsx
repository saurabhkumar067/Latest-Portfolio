  ...
  return (
    <div className='h-screen md:h-screen min-[320px]:h-[50vh] md:p-3 p-3 min-[320px]:p-2 bg-white'>
      <div className='h-full w-full shadow-neutral-900 shadow-md bg-black rounded-[35px] overflow-hidden relative'>
        ...
        <h1 className="z-10 absolute uppercase text-[40vw] xl:text-[30vw] xl:left-7 xl:-bottom-14 md:text-[40vw] min-[320px]:text-[30vw] leading-[33vw] md:leading-[33vw] min-[320px]:leading-[27vw] min-[320px]:left-20 bottom-0 left-16 lg:left-16 md:left-10 tracking-wide font-[anzo4] min-[425px]:left-6 min-[1360px]:left-20">ABOUT</h1>
      </div>
    </div>
  )
}
