  ...
  return (
    ...
    <div className='h-full  text-center md:text-center w-full shadow-neutral-900 shadow-md bg-black rounded-[35px] overflow-hidden relative'>
      ...
      <div className='absolute w-full h-full px-5 flex flex-col justify-evenly items-center'>
            ...
            <div className='min-[320px]:text-start sm:text-center'>
                <h1 className='uppercase text-[12vw] leading-[8.7vw] lg:text-[12vw] min-[320px]:text-[25vw]  lg:leading-[8.7vw] min-[320px]:leading-[18vw] font-[anzo4] tracking-wide sm:text-[20vw] sm:leading-[14vw] min-[425px]:text-start text-center'>Additional</h1>
