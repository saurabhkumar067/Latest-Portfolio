...
function Page1() {
  ...
  return (
    <div onMouseMove={mouseMoving} id="page1" className="h-screen min-[425px]:h-screen min-[320px]:h-[90vh]  bg-white p-3 xl:p-3 lg:p-2 min-[320px]:p-1">
      <div
        id="page1-in"
        style={{
      ...
      >
        ...
        <img
          src={LogoImage}
          alt="Logo"
          className="md:h-16 h-16 min-[320px]:h-12"
        />
