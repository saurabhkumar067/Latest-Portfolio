...
function Page3() {
  return (
    <div className='h-screen xl:h-screen lg:h-[90vh] md:h-[80vh] sm:h-[50vh] min-[320px]:h-[30vh] min-[320px]:mb-8 md:mb-0 relative bg-white flex justify-center items-center'>
      ...
      <video loop muted autoPlay className='h-[67vh] 2xl:h-[55vh] min-[1360px]:h-[67vh] min-[1360px]:w-[50vw] min-[1440px]:h-[77vh] min-[1440px]:w-[50.6vw] xl:h-[77vh] lg:h-[52.5vh] z-10 -top-3 lg:-top-3 md:-top-2 w-[49.6vw] xl:w-[50.4vw] lg:w-[44.3vw] md:h-[44.5vh] md:w-[50.6vw] min-[320px]:h-[32vw] min-[320px]:-top-1 min-[320px]:w-[50.5vw] relative object-cover ' src={Video}></video>
