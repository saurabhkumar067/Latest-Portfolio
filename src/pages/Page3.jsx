...
function Page3() {
  return (
    <div className='h-screen xl:h-screen lg:h-[90vh] md:h-[80vh] sm:h-[50vh] min-[320px]:h-[30vh] min-[320px]:mb-8 md:mb-0 relative bg-white flex justify-center items-center'>
      ...
      {/* <video loop muted autoPlay className='h-[67vh] min-[1360px]:h-[67vh] min-[1360px]:w-[50vw] xl:h-[72vh] lg:h-[52.3vh] z-10 -top-3 lg:-top-3 md:-top-2 w-[49.6vw] xl:w-[50vw] lg:w-[44.3vw] md:h-[45vh] md:w-[50.4vw] min-[320px]:h-[32vw] min-[320px]:-top-1 min-[320px]:w-[50.5vw] relative object-cover' src="https://github.com/saurabhkumar067/Latest-Portfolio/blob/main/src/assets/laptop.mp4?raw=true"></video> */}
      <video loop muted autoPlay className='h-[67vh] 2xl:h-[55vh] min-[1360px]:h-[67vh] min-[1360px]:w-[50vw] min-[1440px]:h-[61vh] min-[1440px]:w-[50.6vw] xl:h-[60vh] lg:h-[43.5vh] z-10 -top-3 lg:-top-3 md:-top-2 w-[49.6vw] xl:w-[50.4vw] lg:w-[44.3vw] md:h-[36.5vh] md:w-[50.6vw] min-[320px]:h-[32vw] min-[320px]:-top-1 min-[320px]:w-[50.5vw] relative object-cover ' src={Video}></video>
